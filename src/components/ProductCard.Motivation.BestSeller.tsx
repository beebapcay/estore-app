...
const ProductCardMotivationBestSeller: React.FC<Props> = ({ item, onTouch, style }) => {
  return (
    <Pressable
      display="flex"
      width="250px"
    ...
    >
      ...
      <Icon as={Ionicons} name="star" color="#EEEC00" size="30px" position="absolute" bottom={2.5} right={2.5} />
    </Pressable>
  );
};

export default ProductCardMotivationBestSeller;

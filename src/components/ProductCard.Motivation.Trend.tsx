...
const ProductCardMotivationTrend: React.FC<Props> = ({ item, onTouch, style }) => {
  return (
    <Pressable
      display="flex"
      width="250px"
    ...
    >
      ...
      <Icon as={Ionicons} name="trending-up" color="#B00020" size="30px" position="absolute" bottom={2.5} right={2.5} />
    </Pressable>
  );
};

export default ProductCardMotivationTrend;
